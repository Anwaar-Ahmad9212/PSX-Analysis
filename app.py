...
st.markdown(
    """
    <div style='
        background: linear-gradient(90deg, #021526 0%, #0B4F8A 100%);
        padding:28px;
        border-radius:10px;
        margin-bottom:20px;
        position:relative;
...
#so the page is divided into 3 sections
# Overview, Visualizations, and Contact
...
#There is if structure for each of the selected page
# Load once to reuse
...
if selected == "Overview":
    ...
    #download and quick data preview
...
#It will show the dropdown menu for each visualizations
#There is a function for each visualization 
#of which call is being made from stock_utils.py file
